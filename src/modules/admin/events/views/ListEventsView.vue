hkjfhf<template>
  <div>
    ...
    <section>
      <div class="d-flex justify-content-between px-5 mt-3">
        <b-form-group class="w-50">
          ...
          <b-input-group>
            <b-form-input placeholder="Buscar evento..." v-model="search" @input="searchEvent" />
        ...
        <div>
          <b-button variant="" :to="{ name: 'event-save' }">Agregar evento &nbsp;
    ...
    <section>
      ...
      <div class="px-5 mt-2">
        <b-row>
          <b-col cols="12" md="4" v-for="event in listEvents" :key="event.id" class="mb-4">
            <b-card no-body class="overflow-hidden h-100">
              <!-- delete  -->

              <div>
                <b-button @click="deleteEvent(event.id)" variant="outline-danger" class="btn-delete-event" size="sm">
                ...
                <b-col lg="6">
                  <b-card-body>
                    ...
                    <div class="d-flex justify-content-between">
                      <b-button :to="{ name: 'work-detail', params: { id: event.id } }" variant="outline-secondary"
