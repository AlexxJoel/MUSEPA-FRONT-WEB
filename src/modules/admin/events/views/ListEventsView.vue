    ...
    <section>
      <div class="d-flex justify-content-between px-5 mt-3">
        <b-form-group class="w-50">
          ...
          <b-input-group>
            <b-form-input placeholder="Buscar evento..." v-model="searchTerm" :disabled="isLoading" />
                  ...
                  <b-col lg="6">
                    <b-card-body>
                      ...
                      <div class="d-flex justify-content-between">
                        <b-button :to="{ name: 'event-detail', params: { id: event.id } }" variant="outline-secondary"
