<template>
    <div>
                ...
                <b-form-group class="w-50">
                    <b-input-group>
                        <b-form-input id="filter-input" v-model="filter" type="search"
                                      placeholder="Buscar usuario"></b-form-input>
        ...
        <section>
            <div class="px-5 mt-2">
                <b-table :items="userList" :fields="fields" :current-page="currentPage" :per-page="perPage"
                         :filter="filter"
                    ...
                    <template #cell(actions)="row">
                        ...
                        <!-- buttton delete -->
                        <b-button size="sm" @click="deleteWork(row.item.id)" variant="danger">
                        ...
                        <!-- buttton edit -->
                        <b-button size="sm" :to="{ name: 'user-detail', params: { id: row.item.id } }"
                                  variant="primary">
...
export default Vue.extend({
    ...
    data() {
        return {
            ...
            fields: [
                {key: 'user.username', label: 'Usuario', sortable: true, sortDirection: 'desc'},
                {key: 'user.email', label: 'Correo electronico', sortable: true, sortDirection: 'desc'},
